...
export default function ApprovedDocumentsPage() {
  ...
  return (
    <>
      <div className="min-h-screen w-full flex flex-col justify-between bg-gray-10">
        <header className="w-full flex flex-col md:flex-row items-center justify-between py-2 px-8 bg-white/90 shadow gap-2 sticky top-0 z-30">
        ...
        <div className="w-full px-8 pt-0 pb-2 bg-white/90 shadow">
